      ...
      <div className="mainc">
        <div className="thecardd">
          <div className="frontc">
            ...
            <img
              src="https://www.tasteofhome.com/wp-content/uploads/2018/01/Lime-Honey-Fruit-Salad_EXPS_BMMZ20_101081_E10_25_6b-4.jpg?resize=768,768"
              alt=""
              height={270}
              width={300}
            />
          ...
          <div className="backc">
            ...
            <p className="met">
              How refreshing it is to have a bowl of fresh fruits?Lime-honey
              fruit salad will open the pores of mind and give you the{" "}
              <i>"Ehsaas OF Taazgi"</i>{" "}
            </p>
          </div>
        </div>
      </div>
