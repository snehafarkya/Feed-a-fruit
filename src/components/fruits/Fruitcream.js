      ...
      <div className="mainc">
        <div className="thecardd">
          ...
          <div className="backc">
            ...
            <p className="met">
              The most simplest and quickest way to have a healthy breakfast.
              Just chop off fruits and nuts , mix them with yogurt and cream and
              put it in fridge for 10 minutes. Viola! Your fruit cream is ready
              to eat.
            </p>
          </div>
        </div>
